...
2. Create a client:
   ```python
    ...
    c = Client('grpc://86.18.245.210:54321')
    ```
...
Start the server with `python -m clip_server`. Let's say it's at `86.18.245.210:54321` with `GRPC` protocol (you will get this information after running the server).
...
c = Client(server='grpc://86.18.245.210:54321')
