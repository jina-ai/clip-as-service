...
from clip_server.model.common_model import CLIPModel
...
class CLIPEncoder(Executor):
    def __init__(
        self,
        name: str = 'XLM-Roberta-Large-Vit-B-32::M-CLIP',
        ...
        **kwargs,
        ...
        self._model = CLIPModel.load(name, self._device, jit)
    ...
    def _preproc_images(self, docs: 'DocumentArray'):
        with self.monitor(
            ...
            return self._model.preproc_img(docs, return_np=False)
    ...
    def _preproc_texts(self, docs: 'DocumentArray'):
        with self.monitor(
            ...
            return self._model.preproc_txt(docs, return_np=False)
